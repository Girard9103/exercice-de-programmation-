/*:
 ...
 Copiez sur cette page les fonctions que vous avez créées dans l’exercice précédent ou réécrivez-les pour vous entraîner. Vous pouvez aussi repartir de zéro.
 
 Modifiez l’une des fonctions de manière à changer totalement le sens du texte ou à apporter une touche amusante. Vous pouvez par exemple remplacer un nom par le vôtre ou par celui d’un ami, remplacer un mot par un autre mot qui rime, ou vous amuser comme vous voulez.
*/
let personage = "pierre.";


func paragrapheUn(){
    
    print("Voila l'histoire vient de commencer de \(personage),")
    print("Mais tous n'est pas finis, car sa ne fait que commencer")
}

func paragrapheDeux(){
    print("lidée est réél")
    print("Mais vous ne connaiser rien")
 ...
 */
//: [Précédent](@previous)  |  page 12 sur 12
